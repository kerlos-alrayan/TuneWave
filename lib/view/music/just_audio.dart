...
//   player.seekToNext();                     // Skip to the next item
//   player.seekToPrevious();                 // Skip to the previous item
//   player.seek(Duration.zero, index: 2);    // Skip to the start of track3.mp3
//   player.setLoopMode(LoopMode.all);        // Set playlist to loop (off|all|one)
//   player.setShuffleModeEnabled(true);      // Shuffle playlist order (true|false)
//   //player.play();
//   }
// }
